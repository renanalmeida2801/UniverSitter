...
import { fetchUser } from './controllers/users/fetchByEmail'
...
import { getSitterByUserId } from './controllers/sitters/getByUserId'
...
export async function appRoutes(app: FastifyInstance) {
  ...
  app.get('/sitterByUserId/:id', getSitterByUserId)
